...
const Join = () => {
  ...
  return (
    <div>
        ...
        <div className=' bg-swarm bg-cover bg-center bg-[url("/Images/bg.jpeg")] w-full h-[100vh] relative'>
            <div className=' h-full w-full bg-black bg-opacity-40 backdrop-blur-lg absolute top-0 z-10'></div>
